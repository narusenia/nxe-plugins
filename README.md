...
| [NXE Pumice](plugins/pumice/docs/requirements/REQ-PUM.md) | Dynamic resonance suppression for a single vocal — the only engine in the line with an FFT on the audio path, and six nodes you place by hand over what it is doing | not released |
