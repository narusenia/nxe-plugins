...
| 済み | 実測 |
|---|---|
| 無音で呼吸しない | 出力ピーク 0、全帯域ゲイン 0、ゲート 0。`LIFT` を開けば −80 dBFS を +2.1 dB 持ち上げる |
| 普通の素材で両側が動く | ピンク −42 dBFS で **+0.54 dB**、−6 dBFS で **−2.14 dB**、−18 dBFS では **−0.22 dB** で素通り |
