...
| Air | 信号駆動の高域テクスチャ生成器（加算 2 系統）**作っている最中** | [要件](../plugins/air/docs/requirements/REQ-AIR.md) / [DSP 仕様](../plugins/air/docs/specifications/dsp.md) / [計画](../plugins/air/docs/implementation/air-plan.md) |
