...
| Pumice | 単体ボーカルの動的共鳴抑制（STFT）**文書のみ** | [要件](../plugins/pumice/docs/requirements/REQ-PUM.md) / [DSP](../plugins/pumice/docs/specifications/dsp.md) / [UI](../plugins/pumice/docs/specifications/ui.md) / [計画](../plugins/pumice/docs/implementation/pumice-plan.md) |
